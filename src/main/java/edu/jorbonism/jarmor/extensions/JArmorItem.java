...
public class JArmorItem extends ArmorItem {
	...
	protected final Multimap<EntityAttribute, EntityAttributeModifier> jAttributeModifiers;
	...
	public JArmorItem(ArmorMaterial material, EquipmentSlot slot, Item.Settings settings) {
		...
		this.jAttributeModifiers = builder.build();
	}

	public Multimap<EntityAttribute, EntityAttributeModifier> getAttributeModifiers(EquipmentSlot slot) {
		return slot == this.slot ? this.jAttributeModifiers : super.getAttributeModifiers(slot);
	}
