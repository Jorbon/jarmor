...
public enum JArmorMaterials implements JArmorMaterial {
	...
	MITHRIL_CHAIN("mithril_chainmail", 27, new int[]{2, 4, 6, 2, 4}, 15, SoundEvents.ITEM_ARMOR_EQUIP_CHAIN, 1f, new int[]{0, 0, 0, 0, 0}, () -> { return Ingredient.ofItems(Jtems.MITHRIL_CHAIN); }),
	MITHRIL_SCALE("mithril_scalemail", 30, new int[]{2, 5, 6, 3, 4}, 15, SoundEvents.ITEM_ARMOR_EQUIP_CHAIN, 2f, new int[]{0, 0, 0, 0, 0}, () -> { return Ingredient.ofItems(Jtems.MITHRIL_SCALE); }),
	...
	IRON_CHAIN("iron_chainmail", 14, new int[]{2, 4, 6, 2, 4}, 9, SoundEvents.ITEM_ARMOR_EQUIP_CHAIN, 1f, new int[]{18, 32, 50, 20, 60}, () -> { return Ingredient.ofItems(Jtems.IRON_CHAIN); }),
	IRON_SCALE("iron_scalemail", 17, new int[]{2, 5, 6, 3, 4}, 9, SoundEvents.ITEM_ARMOR_EQUIP_CHAIN, 2f, new int[]{20, 50, 60, 30, 60}, () -> { return Ingredient.ofItems(Jtems.IRON_SCALE); }),
	...
	GOLD_CHAIN("gold_chainmail", 5, new int[]{1, 2, 4, 1, 2}, 25, SoundEvents.ITEM_ARMOR_EQUIP_CHAIN, 0f, new int[]{20, 55, 80, 25, 100}, () -> { return Ingredient.ofItems(Jtems.GOLD_CHAIN); }),
	GOLD_SCALE("gold_scalemail", 9, new int[]{1, 3, 4, 1, 2}, 25, SoundEvents.ITEM_ARMOR_EQUIP_CHAIN, 0f, new int[]{30, 75, 110, 35, 100}, () -> { return Ingredient.ofItems(Jtems.GOLD_SCALE); }),
